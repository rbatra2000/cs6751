...
struct GetCartesianPathRequest_
{
  ...
  _path_constraints_type path_constraints;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _cartesian_speed_limited_link_type;
...
struct Printer< ::moveit_msgs::GetCartesianPathRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::moveit_msgs::GetCartesianPathRequest_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.cartesian_speed_limited_link);
