...
class InterbotixPointCloudInterface(object):
    def __init__(self, filter_ns="pc_filter", init_node=False):
        ...
        full_img_get_path = "/tmp/save_image.png"
        ...
        self.srv_snap_picture = rospy.ServiceProxy("/" + filter_ns + "/snap_picture", SnapPicture)
        self.full_path_where_to_get_image = full_img_get_path
    ...
    def _snap(self):
        ...
        """
        return self.srv_snap_picture(self.full_path_where_to_get_image)
