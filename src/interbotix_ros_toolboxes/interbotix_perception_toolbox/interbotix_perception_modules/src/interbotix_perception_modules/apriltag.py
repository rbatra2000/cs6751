...
class InterbotixAprilTagInterface(object):
    ...
    def __init__(self, apriltag_ns="apriltag", init_node=False, 
                ...
                full_img_save_path="/home/group8/interbotix_ws/src/interbotix_ros_manipulators/interbotix_ros_xsarms/interbotix_xsarm_perception/scripts/assets/save_image.png",
                verbose=False):
