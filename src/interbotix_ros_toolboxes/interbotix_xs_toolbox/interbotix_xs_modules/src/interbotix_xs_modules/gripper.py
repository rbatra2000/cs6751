...
class InterbotixGripperXS(object):
    def __init__(self, robot_model, gripper_name, robot_name=None, gripper_pressure=0.5, gripper_pressure_lower_limit=150, gripper_pressure_upper_limit=350, init_node=True):#150 gripper_pressure_upper_limit=350, init_node=True):
...
class InterbotixGripperXSInterface(object):
    ...
    def __init__(self, core, gripper_name, gripper_pressure=0.5, gripper_pressure_lower_limit=1, gripper_pressure_upper_limit=10):
        self.core = core
