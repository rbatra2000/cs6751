...
# Then change to this directory and type 'python joint_pwm_control.py  # python3 bartender.py if using ROS Noetic'

def main():
    joint_pwms =  [0, 100 , 100, 25, 0] #[0, 100 , 100, 25, 0,0]#[0, 100 , 100, 25, 0]
